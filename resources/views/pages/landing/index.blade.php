...
@section('content')
    <section class="banner mb-2" style="margin-top:100px;overflow: hidden;">
        <div class="container">
            <div class="row justify-content-center img-banner">
                <div class="col-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <a href="#" target="_blank"><img src="{{ asset('info/banner.jpg') }}"
    ...
    <section class="katalog mt-4" style="overflow: hidden;">
        <div class="container">
            <div class="row justify-content-center mx-1 px-2 py-2">
                <div class="col-12 col-md-5 p-1 align-self-center mb-3 shalat">
                    <div class="row">
                        <div class="col-12">
                ...
                <div class="col-12 col-md-5 align-self-center mb-3 kajian">
                ...
                <div class="col-md-2 align-self-center mb-3 channel">
...
@push('after-script')
    ...
    <script>
        function showJadwal() {
            ...
            $.ajax({
                url: `https://api.myquran.com/v1/sholat/jadwal/1227/`+`${tanggal.getFullYear()}`+`/`+`${month[tanggal.getMonth()]}`+`/`+`${date[tanggal.getDate()]}`,
                type: 'get',
                dataType: 'json',
